<%@ Page Title="" Language="C#" MasterPageFile="~/Master.master" AutoEventWireup="true" CodeFile="go_main.aspx.cs" Inherits="languages_Go_go_main" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <tr>
        <td class="auto-style39" rowspan="4">
            <asp:Image ID="Image22" runat="server" Height="470px" ImageUrl="~/objects/images/languages/Go.png" Width="302px" />
        </td>
        <td>
    ...
    <tr>
        <td class="auto-style3"><h3>Go의 기본적인 개념 학습</h3></td>
    </tr>
    <tr>
        <td>
...
<p>
    ...
    <tr>
        <td rowspan="4" class="auto-style39">
            <asp:Image ID="Image1" runat="server" Height="470px" ImageUrl="~/objects/images/languages/Go.png" Width="302px" />
        </td>
        <td>
    ...
    <tr>
        <td class="auto-style3">Go 최종 정리</td>
    </tr>
    <tr>
        <td>
...
<table class="auto-style44">
    <tr>
        <td class="auto-style39" rowspan="4">
            <asp:Image ID="Image4" runat="server" Height="470px" ImageUrl="~/objects/images/languages/Go.png" Width="302px" />
        </td>
        <td>
...
<table class="auto-style45">
    <tr>
        <td class="auto-style39" rowspan="4">
            <asp:Image ID="Image7" runat="server" Height="470px" ImageUrl="~/objects/images/languages/Go.png" Width="302px" />
        </td>
        <td>
...
<table class="auto-style44">
    <tr>
        <td class="auto-style39" rowspan="5">
            <asp:Image ID="Image10" runat="server" Height="470px" ImageUrl="~/objects/images/languages/Go.png" Width="302px" />
        </td>
    </tr>
    <tr>
        <td><h1>
...
<table class="auto-style41">
    <tr>
        <td rowspan="4" class="auto-style39">
            <asp:Image ID="Image17" runat="server" Height="470px" ImageUrl="~/objects/images/languages/Go.png" Width="302px" />
        </td>
    ...
    <tr>
        <td class="auto-style3"><h3>Go 최종 정리</h3></td>
    </tr>
    <tr>
        <td>
