...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <tr>
        <td class="auto-style3"><h3>PHP의 기본적인 개념 학습</h3></td>
    </tr>
    <tr>
        <td>
                <asp:ImageButton ID="ImageButton1" runat="server" Height="101px" ImageUrl="~/objects/images/php_startlesson_2.png" Width="337px" OnClick="ImageButton1_Click" />
        </td>
    </tr>
</table>
<p>
    ...
    <tr>
        <td>
                <asp:ImageButton ID="ImageButton2" runat="server" Height="101px" ImageUrl="~/objects/images/php_startlesson_2.png" Width="337px" OnClick="ImageButton2_Click" />
        </td>
    </tr>
</table>
            </td>
...
<table class="auto-style44">
    ...
    <tr>
        <td>
                <asp:ImageButton ID="ImageButton6" runat="server" ImageUrl="~/objects/images/php_startlesson_2.png" OnClick="ImageButton6_Click" />
        </td>
    </tr>
</table>
<p>
...
<p>
    ...
    <tr>
        <td>
                <asp:ImageButton ID="ImageButton7" runat="server" ImageUrl="~/objects/images/php_startlesson_2.png" OnClick="ImageButton7_Click" />
        </td>
    </tr>
</table>
            </td>
...
<table class="auto-style45">
    ...
    <tr>
        <td>
                <asp:ImageButton ID="ImageButton8" runat="server" ImageUrl="~/objects/images/php_startlesson_2.png" OnClick="ImageButton8_Click" />
        </td>
    </tr>
</table>
...
<p>
    ...
    <tr>
        <td>
                <asp:ImageButton ID="ImageButton9" runat="server" ImageUrl="~/objects/images/php_startlesson_2.png" OnClick="ImageButton9_Click" />
        </td>
    </tr>
</table>
            </td>
